import 'package:fluttertodolistsqfliteapp/repositories/dbcon.dart';
...
class Repository {
  ...
  searchTodo(table, sword) async {
    var connection = await database;
    return await connection.query(table, where: 'title LIKE ?' , whereArgs: ['%$sword%']);
